...
mod tree_cache_tests {
    ...
    fn create_test_category(
        ...
        Category {
            ...
            slug: slug.to_string(),
            name: name.to_string(),
            short_description: format!("{name} description"),
    ...
    fn test_tree_cache_creation() {
        ...
        assert!(cache.tree.contains_key(
            &cache
                .tree
                .values()
    ...
    fn test_hierarchical_tree_cache() {
        ...
        let has_smartphones = electronics_node
            .children
            .values()
            .any(|child| child.slug == "smartphones");
        let has_laptops = electronics_node
            .children
            .values()
            .any(|child| child.slug == "laptops");
    ...
    fn test_deep_hierarchy_tree_cache() {
        ...
        // Level 2: Smartphones
        let smartphones =
            create_test_category("smartphones", "Smartphones", Some(mobile_id.clone()), 2, 1);
    ...
    fn test_multiple_root_categories_tree_cache() {
        ...
        let category_names: Vec<String> =
            cache.tree.values().map(|node| node.name.clone()).collect();
    ...
    fn test_tree_cache_performance_structure() {
        ...
        // Major subcategories
        let computers =
            create_test_category("computers", "Computers", Some(electronics_id.clone()), 1, 1);
        ...
        assert!(electronics_node
            .children
            .values()
            .any(|child| child.name == "Computers"));
        assert!(electronics_node
            .children
            .values()
            .any(|child| child.name == "Phones"));

        let computers_children: Vec<&str> = computers_node
            .children
            .values()
